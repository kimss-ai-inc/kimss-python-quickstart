...
[kimss-ai/kimss-python-quickstart](https://github.com/kimss-ai/kimss-python-quickstart) is a **force-push mirror** of `kimss_quickstart/` in the Kimss API monorepo. Direct PRs to public `main` are overwritten on the next mirror.

## How to report issues

Use [GitHub Issues](https://github.com/kimss-ai/kimss-python-quickstart/issues) on this repository. English is fine. Include the example script, Python version, and the error.
